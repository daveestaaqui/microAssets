...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_word-counter"], (res) => {
        if (res["omnisuite_pro_key_word-counter"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/9B66oH15Y5f54LH2tM0ZW1W?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "word-counter" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_word-counter"] = key;
