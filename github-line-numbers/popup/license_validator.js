...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_github-line-numbers"], (res) => {
        if (res["omnisuite_pro_key_github-line-numbers"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/7sY3cv01U9vl4LH9We0ZW14?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "github-line-numbers" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_github-line-numbers"] = key;
