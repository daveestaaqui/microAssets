...
(function() {
  ...
  const EXT_ID = 'base64_encoder_and_decoder_tool';
...
document.getElementById('encBtn').onclick=()=>{try{out.value=btoa(unescape(encodeURIComponent(inp.value)));}catch(e){out.value='Error: '+e.message;}};
document.getElementById('decBtn').onclick=()=>{try{out.value=decodeURIComponent(escape(atob(inp.value)));}catch(e){out.value='Error: '+e.message;}};
