...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_reading-time-badge"], (res) => {
        if (res["omnisuite_pro_key_reading-time-badge"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/00w5kD8yq5f5fqlgkC0ZW1B?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "reading-time-badge" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_reading-time-badge"] = key;
