...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_diff-viewer"], (res) => {
        if (res["omnisuite_pro_key_diff-viewer"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/7sYfZh3e636X91X0lE0ZW0X?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "diff-viewer" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_diff-viewer"] = key;
