...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_dark-mode-everywhere"], (res) => {
        if (res["omnisuite_pro_key_dark-mode-everywhere"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/cNi14ndSK6j9ba56K20ZW0V?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "dark-mode-everywhere" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_dark-mode-everywhere"] = key;
