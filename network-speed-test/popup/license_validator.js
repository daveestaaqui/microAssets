...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_network-speed-test"], (res) => {
        if (res["omnisuite_pro_key_network-speed-test"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/9B6bJ17umgXN7XTd8q0ZW1r?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "network-speed-test" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_network-speed-test"] = key;
