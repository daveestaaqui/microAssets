...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_timestamp-converter"], (res) => {
        if (res["omnisuite_pro_key_timestamp-converter"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/7sYeVdcOGdLB2Dz8Sa0ZW1O?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "timestamp-converter" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_timestamp-converter"] = key;
