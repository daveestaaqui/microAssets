...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_bookmark-manager"], (res) => {
        if (res["omnisuite_pro_key_bookmark-manager"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/9B6aEX4iaazp2DzgkC0ZW0E?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "bookmark-manager" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_bookmark-manager"] = key;
