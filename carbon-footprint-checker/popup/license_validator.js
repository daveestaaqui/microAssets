...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_carbon-footprint-checker"], (res) => {
        if (res["omnisuite_pro_key_carbon-footprint-checker"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/9B600jcOG6j94LH1pI0ZW0F?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "carbon-footprint-checker" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_carbon-footprint-checker"] = key;
