...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_tab-groups-saver"], (res) => {
        if (res["omnisuite_pro_key_tab-groups-saver"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/5kQ28r4iadLB5PLecu0ZW1K?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "tab-groups-saver" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_tab-groups-saver"] = key;
