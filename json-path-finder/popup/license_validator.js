...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_json-path-finder"], (res) => {
        if (res["omnisuite_pro_key_json-path-finder"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/9B68wP9CuePF1zvd8q0ZW1g?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "json-path-finder" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_json-path-finder"] = key;
