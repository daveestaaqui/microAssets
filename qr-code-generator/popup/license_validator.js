...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_qr-code-generator"], (res) => {
        if (res["omnisuite_pro_key_qr-code-generator"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/cNibJ1eWO8rh1zv4BU0ZW1y?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "qr-code-generator" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_qr-code-generator"] = key;
