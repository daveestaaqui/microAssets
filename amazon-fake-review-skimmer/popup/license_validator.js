...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_amazon-fake-review-skimmer"], (res) => {
        if (res["omnisuite_pro_key_amazon-fake-review-skimmer"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/cNi28r8yqePFce92tM0ZW0A?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "amazon-fake-review-skimmer" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_amazon-fake-review-skimmer"] = key;
