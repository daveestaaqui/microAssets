...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_regex-tester"], (res) => {
        if (res["omnisuite_pro_key_regex-tester"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/aFaeVdeWO36XemhgkC0ZW1D?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "regex-tester" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_regex-tester"] = key;
