...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_robots-viewer"], (res) => {
        if (res["omnisuite_pro_key_robots-viewer"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/6oUaEXcOG0YP5PL8Sa0ZW1F?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "robots-viewer" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_robots-viewer"] = key;
