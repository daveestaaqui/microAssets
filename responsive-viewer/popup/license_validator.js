...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_responsive-viewer"], (res) => {
        if (res["omnisuite_pro_key_responsive-viewer"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/9B68wPeWO5f5fql8Sa0ZW1E?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "responsive-viewer" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_responsive-viewer"] = key;
