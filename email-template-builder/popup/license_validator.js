...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_email-template-builder"], (res) => {
        if (res["omnisuite_pro_key_email-template-builder"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/5kQaEX9Cu4b1a612tM0ZW0Z?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "email-template-builder" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_email-template-builder"] = key;
