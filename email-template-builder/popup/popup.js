...
document.getElementById('newBtn').onclick=()=>{chrome.storage.local.get(['emailTemplates','omnisuite_pro_key_email-template-builder'],d=>{const t=d.emailTemplates||defaults;if(t.length>=MAX_FREE&&!d['omnisuite_pro_key_email-template-builder']){document.getElementById('gate').style.display='block';return;}document.getElementById('editor').style.display='block';});};
