...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_css-grid-generator"], (res) => {
        if (res["omnisuite_pro_key_css-grid-generator"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/14A6oH01U7nddid2tM0ZW0S?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "css-grid-generator" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_css-grid-generator"] = key;
