...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_reading-mode"], (res) => {
        if (res["omnisuite_pro_key_reading-mode"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/3cI3cveWO6j90vr7O60ZW1A?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "reading-mode" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_reading-mode"] = key;
