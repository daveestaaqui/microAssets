...
(function() {
  ...
  const EXT_ID = 'url_encoder_decoder';
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('encode').onclick = () => output.value = encodeURIComponent(input.value);
  document.getElementById('decode').onclick = () => { try { output.value = decodeURIComponent(input.value); } catch(e) { output.value = 'Invalid encoded URL'; } };
