...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_whois-lookup"], (res) => {
        if (res["omnisuite_pro_key_whois-lookup"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/eVq00jaGygXN7XTb0i0ZW1V?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "whois-lookup" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_whois-lookup"] = key;
