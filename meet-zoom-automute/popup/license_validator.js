...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_meet-zoom-automute"], (res) => {
        if (res["omnisuite_pro_key_meet-zoom-automute"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/cNieVd7umazpa614BU0ZW1n?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "meet-zoom-automute" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_meet-zoom-automute"] = key;
