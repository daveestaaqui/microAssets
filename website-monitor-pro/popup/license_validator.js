...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_website-monitor-pro"], (res) => {
        if (res["omnisuite_pro_key_website-monitor-pro"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/cNi00j7um4b1did3xQ0ZW1U?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "website-monitor-pro" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_website-monitor-pro"] = key;
