...
chrome.storage.local.get(['monitors','omnisuite_pro_key_website-monitor-pro'],d=>{const m=d.monitors||{};if(Object.keys(m).length>=MAX_FREE&&!d['omnisuite_pro_key_website-monitor-pro']){document.getElementById('gate').style.display='block';return;}
