...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_diff-checker"], (res) => {
        if (res["omnisuite_pro_key_diff-checker"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/8x228r3e6fTJemh4BU0ZW0W?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "diff-checker" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_diff-checker"] = key;
