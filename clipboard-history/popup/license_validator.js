...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_clipboard-history"], (res) => {
        if (res["omnisuite_pro_key_clipboard-history"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/7sYfZh2a25f5ce96K20ZW0G?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "clipboard-history" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_clipboard-history"] = key;
