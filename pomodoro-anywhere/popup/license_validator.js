...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_pomodoro-anywhere"], (res) => {
        if (res["omnisuite_pro_key_pomodoro-anywhere"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/9B64gz2a2dLBgup7O60ZW1w?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "pomodoro-anywhere" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_pomodoro-anywhere"] = key;
