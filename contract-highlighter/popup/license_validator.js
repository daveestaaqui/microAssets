...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_contract-highlighter"], (res) => {
        if (res["omnisuite_pro_key_contract-highlighter"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/3cI4gz7um22T4LH0lE0ZW0K?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "contract-highlighter" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_contract-highlighter"] = key;
