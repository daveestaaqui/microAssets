...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_http-status-checker"], (res) => {
        if (res["omnisuite_pro_key_http-status-checker"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/4gMbJ1bKC22T2Dz9We0ZW1a?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "http-status-checker" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_http-status-checker"] = key;
