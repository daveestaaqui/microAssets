...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_form-filler-pro"], (res) => {
        if (res["omnisuite_pro_key_form-filler-pro"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/eVq3cv7um36X2Dz2tM0ZW12?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "form-filler-pro" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_form-filler-pro"] = key;
