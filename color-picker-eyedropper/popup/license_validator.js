...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_color-picker-eyedropper"], (res) => {
        if (res["omnisuite_pro_key_color-picker-eyedropper"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/5kQ6oH6qi0YP91X5FY0ZW0J?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "color-picker-eyedropper" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_color-picker-eyedropper"] = key;
