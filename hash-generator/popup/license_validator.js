...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_hash-generator"], (res) => {
        if (res["omnisuite_pro_key_hash-generator"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/00w6oH8yq0YPdidc4m0ZW17?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "hash-generator" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_hash-generator"] = key;
