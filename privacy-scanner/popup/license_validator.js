...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_privacy-scanner"], (res) => {
        if (res["omnisuite_pro_key_privacy-scanner"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/fZu28r3e636X7XTb0i0ZW1x?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "privacy-scanner" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_privacy-scanner"] = key;
