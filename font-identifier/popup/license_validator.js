...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_font-identifier"], (res) => {
        if (res["omnisuite_pro_key_font-identifier"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/aFa8wP3e636XemhgkC0ZW11?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "font-identifier" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_font-identifier"] = key;
