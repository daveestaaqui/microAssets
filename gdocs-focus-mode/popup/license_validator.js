...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_gdocs-focus-mode"], (res) => {
        if (res["omnisuite_pro_key_gdocs-focus-mode"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/fZufZhg0S36X1zv1pI0ZW13?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "gdocs-focus-mode" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_gdocs-focus-mode"] = key;
