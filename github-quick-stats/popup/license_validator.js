...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_github-quick-stats"], (res) => {
        if (res["omnisuite_pro_key_github-quick-stats"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/5kQbJ1aGy7nd91X2tM0ZW15?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "github-quick-stats" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_github-quick-stats"] = key;
