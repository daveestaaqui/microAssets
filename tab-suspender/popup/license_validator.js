...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_tab-suspender"], (res) => {
        if (res["omnisuite_pro_key_tab-suspender"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/eVq4gz3e65f56TP4BU0ZW1L?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "tab-suspender" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_tab-suspender"] = key;
