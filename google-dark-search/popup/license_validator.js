...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_google-dark-search"], (res) => {
        if (res["omnisuite_pro_key_google-dark-search"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/5kQcN54ia6j9fqlgkC0ZW16?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "google-dark-search" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_google-dark-search"] = key;
