...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_meta-tag-editor"], (res) => {
        if (res["omnisuite_pro_key_meta-tag-editor"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/fZu14n8yqcHxa615FY0ZW1o?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "meta-tag-editor" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_meta-tag-editor"] = key;
