...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_dom-editor-pro"], (res) => {
        if (res["omnisuite_pro_key_dom-editor-pro"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/aFacN52a222T1zv6K20ZW0Y?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "dom-editor-pro" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_dom-editor-pro"] = key;
