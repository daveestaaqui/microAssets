...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_css-box-shadow"], (res) => {
        if (res["omnisuite_pro_key_css-box-shadow"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/4gMbJ1aGy4b1ce9b0i0ZW0P?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "css-box-shadow" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_css-box-shadow"] = key;
