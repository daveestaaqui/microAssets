...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_instagram-clean-feed"], (res) => {
        if (res["omnisuite_pro_key_instagram-clean-feed"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/9B6aEX4iagXNba58Sa0ZW1b?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "instagram-clean-feed" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_instagram-clean-feed"] = key;
