...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_link-checker"], (res) => {
        if (res["omnisuite_pro_key_link-checker"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/8x2eVdaGy36Xdidecu0ZW1i?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "link-checker" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_link-checker"] = key;
