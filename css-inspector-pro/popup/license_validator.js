...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_css-inspector-pro"], (res) => {
        if (res["omnisuite_pro_key_css-inspector-pro"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/bJe4gz5me8rh4LH8Sa0ZW0T?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "css-inspector-pro" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_css-inspector-pro"] = key;
