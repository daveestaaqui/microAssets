...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_color-palette-generator"], (res) => {
        if (res["omnisuite_pro_key_color-palette-generator"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/8x2fZh4iaazpdid5FY0ZW0I?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "color-palette-generator" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_color-palette-generator"] = key;
