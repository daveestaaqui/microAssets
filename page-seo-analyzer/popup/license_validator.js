...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_page-seo-analyzer"], (res) => {
        if (res["omnisuite_pro_key_page-seo-analyzer"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/eVq00jbKC4b1ce99We0ZW1u?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "page-seo-analyzer" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_page-seo-analyzer"] = key;
