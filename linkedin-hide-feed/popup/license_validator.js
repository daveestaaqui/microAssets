...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_linkedin-hide-feed"], (res) => {
        if (res["omnisuite_pro_key_linkedin-hide-feed"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/aFa8wPbKC36X2Dz9We0ZW1j?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "linkedin-hide-feed" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_linkedin-hide-feed"] = key;
