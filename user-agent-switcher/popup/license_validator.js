...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_user-agent-switcher"], (res) => {
        if (res["omnisuite_pro_key_user-agent-switcher"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/14A3cvcOG7nd0vrgkC0ZW1R?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "user-agent-switcher" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_user-agent-switcher"] = key;
