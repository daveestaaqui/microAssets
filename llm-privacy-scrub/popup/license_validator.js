...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_llm-privacy-scrub"], (res) => {
        if (res["omnisuite_pro_key_llm-privacy-scrub"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/eVqaEX4ia8rhba5b0i0ZW1k?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "llm-privacy-scrub" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_llm-privacy-scrub"] = key;
