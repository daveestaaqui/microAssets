...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_cookie-manager"], (res) => {
        if (res["omnisuite_pro_key_cookie-manager"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/8x26oH8yqdLB3HDd8q0ZW0M?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "cookie-manager" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_cookie-manager"] = key;
