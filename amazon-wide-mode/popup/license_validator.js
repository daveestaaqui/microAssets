...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_amazon-wide-mode"], (res) => {
        if (res["omnisuite_pro_key_amazon-wide-mode"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/7sYbJ19CufTJ0vrgkC0ZW0B?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "amazon-wide-mode" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_amazon-wide-mode"] = key;
