...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_page-ruler"], (res) => {
        if (res["omnisuite_pro_key_page-ruler"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/bJe5kDaGyePFdidecu0ZW1t?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "page-ruler" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_page-ruler"] = key;
