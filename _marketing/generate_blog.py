...
def generate_blog():
    ...
    for filename in sorted(os.listdir(ARTICLES_DIR)):
        if filename.endswith(".md"):
            ...
            hero_image_tag = f'<img src="{hero_image}?v=912" alt="{title}" class="blog-hero-img" style="width:100%; height:320px; object-fit:cover; border-radius:var(--radius-lg); margin-top:24px; border:1px solid var(--border-color);">'
