...
for guide in guides:
    ...
    hero_image_tag = f'<img src="{hero_image}" alt="{guide["title"]}" class="guide-hero-img" style="width:100%; height:320px; object-fit:cover; border-radius:var(--radius-lg); margin-top:24px; border:1px solid var(--border-color);">'
