...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_code-snippet-manager"], (res) => {
        if (res["omnisuite_pro_key_code-snippet-manager"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/3cIaEX5mecHx5PL8Sa0ZW0H?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "code-snippet-manager" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_code-snippet-manager"] = key;
