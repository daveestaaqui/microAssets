...
chrome.storage.local.get(['snippets','omnisuite_pro_key_code-snippet-manager'],d=>{const s=d.snippets||[];if(s.length>=MAX_FREE&&!d['omnisuite_pro_key_code-snippet-manager']){document.getElementById('gate').style.display='block';return;}
