...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_time-tracker"], (res) => {
        if (res["omnisuite_pro_key_time-tracker"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/5kQbJ14iaePF4LH5FY0ZW1N?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "time-tracker" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_time-tracker"] = key;
