...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_screenshot-capture"], (res) => {
        if (res["omnisuite_pro_key_screenshot-capture"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/fZufZhcOGazp0vr3xQ0ZW1G?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "screenshot-capture" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_screenshot-capture"] = key;
