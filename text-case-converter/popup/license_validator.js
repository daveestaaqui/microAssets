...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_text-case-converter"], (res) => {
        if (res["omnisuite_pro_key_text-case-converter"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/5kQ9AT01U7nd6TPb0i0ZW1M?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "text-case-converter" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_text-case-converter"] = key;
