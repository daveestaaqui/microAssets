...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_css-minifier"], (res) => {
        if (res["omnisuite_pro_key_css-minifier"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/fZuaEXaGy8rha614BU0ZW0U?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "css-minifier" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_css-minifier"] = key;
