...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_sponsor-skipper"], (res) => {
        if (res["omnisuite_pro_key_sponsor-skipper"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/9B64gz15Y36X1zvecu0ZW1J?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "sponsor-skipper" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_sponsor-skipper"] = key;
