...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_markdown-preview"], (res) => {
        if (res["omnisuite_pro_key_markdown-preview"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/dRm5kD6qi9vl0vr8Sa0ZW1m?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "markdown-preview" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_markdown-preview"] = key;
