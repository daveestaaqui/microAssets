...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_url-encoder-decoder"], (res) => {
        if (res["omnisuite_pro_key_url-encoder-decoder"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/4gM14naGycHxfql4BU0ZW1P?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "url-encoder-decoder" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_url-encoder-decoder"] = key;
