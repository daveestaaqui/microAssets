...
# Search for emails FROM instagram or containing "sporlyworks"
search_queries = ['FROM "instagram.com"', 'TEXT "sporlyworks"', 'SUBJECT "Instagram"']
found_messages = []
...
print(f"Found {len(found_messages)} specific matching emails.")
