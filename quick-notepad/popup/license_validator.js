...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_quick-notepad"], (res) => {
        if (res["omnisuite_pro_key_quick-notepad"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/8x23cv4ia4b16TPgkC0ZW1z?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "quick-notepad" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_quick-notepad"] = key;
