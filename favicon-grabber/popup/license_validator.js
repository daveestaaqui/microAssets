...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_favicon-grabber"], (res) => {
        if (res["omnisuite_pro_key_favicon-grabber"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/14AaEX01UdLB0vrecu0ZW10?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "favicon-grabber" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_favicon-grabber"] = key;
