...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_url-shortener"], (res) => {
        if (res["omnisuite_pro_key_url-shortener"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/bJeeVddSK5f56TP6K20ZW1Q?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "url-shortener" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_url-shortener"] = key;
