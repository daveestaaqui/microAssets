...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_wayback-machine-quick"], (res) => {
        if (res["omnisuite_pro_key_wayback-machine-quick"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/5kQaEX7um4b1emh3xQ0ZW1S?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "wayback-machine-quick" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_wayback-machine-quick"] = key;
