...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_base64-encoder"], (res) => {
        if (res["omnisuite_pro_key_base64-encoder"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/00weVd7umcHxemh9We0ZW0D?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "base64-encoder" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_base64-encoder"] = key;
