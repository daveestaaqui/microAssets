...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_jwt-decoder"], (res) => {
        if (res["omnisuite_pro_key_jwt-decoder"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/bJe8wPeWO9vlce91pI0ZW1h?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "jwt-decoder" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_jwt-decoder"] = key;
