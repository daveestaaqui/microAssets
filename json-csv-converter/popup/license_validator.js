...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.local.get(["omnisuite_pro_key_json-csv-converter"], (res) => {
        if (res["omnisuite_pro_key_json-csv-converter"]) {
            unlockPro();
        }
    });
    ...
    btnUpgrade.addEventListener("click", () => {
        ...
        window.open("https://buy.stripe.com/28E9ATaGy0YP3HD7O60ZW1e?client_reference_id=" + uuid, "_blank");
    ...
    btnVerify.addEventListener("click", async () => {
        ...
        try {
            ...
            if (data.valid && (data.product === "json-csv-converter" || data.product === "omnisuite-master-suite")) {
                let obj = {};
                obj["omnisuite_pro_key_json-csv-converter"] = key;
